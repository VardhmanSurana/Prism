...
import { Trash2, AlertTriangle, Lock, Unlock, AlertCircle, X } from 'lucide-react';
...
export const ConfirmDialog: React.FC = () => {
  ...
  // Autofocus the confirm button when opened to allow quick 'Enter' key confirmation
  useEffect(() => {
    if (state?.isOpen) {
      setTimeout(() => {
  ...
  // Determine modal theme based on operation keywords
  ...
  // Select suitable icon and styling
