...
const MemoryCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div className={`absolute rounded-full bg-black/60 border border-white/10 flex items-center justify-center text-white/90 group-hover:text-primary transition-transform 500ms cubic-bezier(0.23, 1, 0.32, 1), transition-colors 500ms ease, border-color 500ms ease group-hover:border-primary/30 group-hover:scale-110 shadow-xl
