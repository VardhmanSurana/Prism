        ...
        PackManifest {
            ...
            models: vec![
                PackModelDef {
                    ...
                    name: "ISNet (High Quality)".to_string(),
                    description: Some("Highly accurate dichotomic segmentation model for universal portrait & object cutout.".to_string()),
                    ...
                    download: Some(PackDownloadDef {
                        url: "https://huggingface.co/ZhengPeng7/BiRefNet/resolve/main/isnet-general-use.onnx".to_string(),
                        sha256: Some("587c60ee1f24d77ea41829e160a2b724f7f6f89fe6ce1a31d9c1e7a561168f18".to_string()),
                ...
                PackModelDef {
                    ...
                    download: Some(PackDownloadDef {
                        url: "https://huggingface.co/ZhengPeng7/BiRefNet/resolve/main/BiRefNet-general-epoch_244.onnx".to_string(),
                        sha256: None,
